...
namespace  nPhysics
{
	...
	// Delegates to a "btDiscreteDynamicWorld"
	...
	private:
		...
		btDefaultCollisionConfiguration* mCollisions;
		btSequentialImpulseConstraintSolver* mConstraints;
		btDbvtBroadphase* mOverlappingPairs;
